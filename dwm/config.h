...
static const char col_sel[]         = "#474747";
static const char *colors[][3]      = {
    /*               fg         bg         border   */
    [SchemeNorm] = {  "#bbbbbb",  "#222222",  "#444444" },
    [SchemeSel]  = {  "#eeeeee", col_sel,    "#eeeeee" },
};
...
// static const char *runcmd[]     = { "imm", NULL };
...
static const Key keys[] = {
    ...
    { MODKEY|ShiftMask,             XK_Return, zoom,           {0} }, // Promotes window to master
    { MODKEY,                       XK_Tab,    view,           {0} }, // Toggle last viewed tags
